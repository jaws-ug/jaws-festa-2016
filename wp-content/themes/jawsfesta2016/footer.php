...
?>
		...
		<?php do_action( 'jawsfesta_after_content' ); ?>
	</div><!-- #content -->
	...
	<section id="jawsfesta-contact-box" class="footer-section jawsfesta-contact-box"><div class="inner">
		<p class="contact-text"><?php
			echo sprintf(
				...
				esc_html__( 'To participate in the JAWS FESTA %d', 'jawsfesta' ),
				2016
			);
		?></p>
		<p class="contact-button"><a href="<?php echo home_url('/ticket'); ?>"><?php esc_html_e( 'Tickets', 'jawsfesta' ); ?></a></p>
	</div></section>

	<footer id="colophon" class="site-footer" role="contentinfo"><div class="inner">
		<?php do_action( 'jawsfesta_before_footer' ); ?>
		...
		<div class="site-info">
			<div class="social-button">
				<ul>
					<li><a href="https://twitter.com/intent/tweet?text=<?php echo rawurlencode( get_bloginfo( 'name' ) ); ?>&url=<?php echo rawurlencode( home_url( '/' ) ); ?>&hashtags=jawsfesta, jawsug&via=jawsfesta" target="_blank">
<i class="fa fa-twitter-square"></i></a></li>
		...
		<?php do_action( 'jawsfesta_after_footer' ); ?>
	</div></footer><!-- #colophon -->
</div><!-- #page -->

<?php do_action( 'jawsfesta_after_body' ); ?>
